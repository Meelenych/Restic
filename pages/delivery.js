			...
			<div className='container mx-auto p-4'>
				...
				<form
					...
					<div className='flex flex-wrap'>
						<div className='flex flex-wrap border border-emerald-200 rounded-xl p-3 w-full mb-3'>
							{/* First name */}
						...
						<div className='flex flex-wrap border border-emerald-200 rounded-xl p-3 w-full'>
